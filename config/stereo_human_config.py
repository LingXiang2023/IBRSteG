...
class ConfigStereoHuman:
    def __init__(self):
        ...
        self.cfg.record.save_iter = [3000,4000,5000,6000,7000,8000,9000,10000,12500,15000,17500,20000,22500,30000,40000,50000,60000,70000,80000,90000]
        self.cfg.record.loss_freq = 0
        self.cfg.record.eval_freq = 0
        self.cfg.record.show_freq = 100
        
        self.cfg.loss = CN()
        self.cfg.loss.lambda2d =0.0
        self.cfg.loss.lambdaemb =1.0
        self.cfg.loss.lambdare =0.75
        self.cfg.loss.lambdadepth = 0.0
        self.cfg.loss.lambdargb =1.0
        self.cfg.loss.lambdaalpha =0.0
    def get_cfg(self):
